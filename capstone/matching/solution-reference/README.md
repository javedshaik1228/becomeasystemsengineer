# Optional completed reference

> Stop. This directory is not the learner project. Use it only when a guided step's stuck protocol explicitly allows one small comparison, then close it and reimplement from memory.
